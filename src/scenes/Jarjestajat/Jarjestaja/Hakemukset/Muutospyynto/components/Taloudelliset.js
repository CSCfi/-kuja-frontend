  ...
  render() {
    ...
    return (
      <div>
        ...
        <FormGroup>
          <Label>
            {MUUTOS_WIZARD_TEKSTIT.TALOUDELLISET.OMAVARAISUUSASTE.FI}
          </Label>
          <FormField>
            <input
              type="number"
        ...
        <FormGroup>
          <Label>
            {MUUTOS_WIZARD_TEKSTIT.TALOUDELLISET.VELKAANTUNEISUUS.FI}
          </Label>
          <FormField>
            <input
              type="number"
        ...
        <FormGroup>
          ...
          <FormField>
            <input
              type="number"
              defaultValue={
                kumulatiivinen !== null ? kumulatiivinen : undefined
              }
              onBlur={e => {
                let obj = fields.get(0);
