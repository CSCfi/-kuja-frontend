        ...
        <Area>
          ...
          <textarea
            ...
            onBlur={e => {
              ...
              obj.meta.perusteluteksti_kuljetus_perus.tarpeellisuus =
                e.target.value;
              fields.remove(i);
              fields.insert(i, obj);
            }}
          ...
          <InputWrapper>
            <DatePicker
              ...
              onChange={date => {
                const i = getIndex(muutokset, koodiarvo);
                let obj = fields.get(i);
                obj.meta.perusteluteksti_kuljetus_perus.voimassaoleva_pvm = date.format(
                  "DD.MM.YYYY"
                );
                fields.remove(i);
                fields.insert(i, obj);
          ...
          <textarea
            ...
            onBlur={e => {
              const i = getIndex(muutokset, koodiarvo);
              let obj = fields.get(i);
              obj.meta.perusteluteksti_kuljetus_perus.suunnitelma =
                e.target.value;
              fields.remove(i);
              fields.insert(i, obj);
            }}
          ...
          <InputWrapper>
            <input
              ...
              onBlur={e => {
                const i = getIndex(muutokset, koodiarvo);
                let obj = fields.get(i);
                obj.meta.perusteluteksti_kuljetus_perus.toimipisteet.nimi =
                  e.target.value;
                fields.remove(i);
                fields.insert(i, obj);
              }}
          ...
          <InputWrapper>
            <input
              ...
              onBlur={e => {
                const i = getIndex(muutokset, koodiarvo);
                let obj = fields.get(i);
                obj.meta.perusteluteksti_kuljetus_perus.kanta_linja_auto =
                  e.target.value;
                fields.remove(i);
                fields.insert(i, obj);
              }}
          ...
          <InputWrapper>
            <input
              ...
              onBlur={e => {
                const i = getIndex(muutokset, koodiarvo);
                let obj = fields.get(i);
                obj.meta.perusteluteksti_kuljetus_perus.kanta_kuorma_auto =
                  e.target.value;
                fields.remove(i);
                fields.insert(i, obj);
              }}
          ...
          <InputWrapper>
            <input
              ...
              onBlur={e => {
                const i = getIndex(muutokset, koodiarvo);
                let obj = fields.get(i);
                obj.meta.perusteluteksti_kuljetus_perus.kanta_peravaunu =
                  e.target.value;
                fields.remove(i);
                fields.insert(i, obj);
              }}
          ...
          <textarea
            ...
            onBlur={e => {
              const i = getIndex(muutokset, koodiarvo);
              let obj = fields.get(i);
              obj.meta.perusteluteksti_kuljetus_perus.valineet_asetus =
                e.target.value;
              fields.remove(i);
              fields.insert(i, obj);
            }}
          ...
          <textarea
            ...
            onBlur={e => {
              const i = getIndex(muutokset, koodiarvo);
              let obj = fields.get(i);
              obj.meta.perusteluteksti_kuljetus_perus.valineet_muut =
                e.target.value;
              fields.remove(i);
              fields.insert(i, obj);
            }}
