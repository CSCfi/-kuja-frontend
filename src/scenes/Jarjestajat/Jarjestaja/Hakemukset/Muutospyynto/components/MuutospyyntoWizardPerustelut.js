...
const MuutospyyntoWizardPerustelut = ({
  ...
  // let isTutkinnotChanges;
  // let isKoulutuksetChanges;
  // let isOpetuskieletChanges;
  // let isTutkintokieletChanges;
  // let isToimintaalueChanges;
  // let isOpiskelijavuodetChanges;
  // let isMuutChanges;
  // let anyChanges;
  useEffect(() => {
