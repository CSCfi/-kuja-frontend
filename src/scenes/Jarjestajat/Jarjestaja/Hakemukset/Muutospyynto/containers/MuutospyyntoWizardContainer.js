...
import { fetchKoulutuksetAll, fetchKoulutuksetMuut, fetchKoulutus } from "services/koulutukset/reducer"
...
class MuutospyyntoWizardContainer extends React.Component {
  state: {}
