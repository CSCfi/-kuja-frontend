...
export const ModalButton = styled.button`
  color: ${props => props.disabled ? COLORS.WHITE : props.primary ? COLORS.WHITE : COLORS.OIVA_GREEN};
  background-color: ${props => props.disabled ? COLORS.LIGHT_GRAY : props.primary ? COLORS.OIVA_GREEN : COLORS.WHITE};
  border: 1px solid ${props => props.disabled ? COLORS.LIGHT_GRAY : COLORS.OIVA_GREEN};
  cursor: pointer;
