    ...
    render() {
      ...
      return (
        <PerusteluTyovoimaWrapper>
          <h4>{MUUTOS_WIZARD_TEKSTIT.MUUTOS_PERUSTELULOMAKKEET.VAATIVA.KUVAUS.FI}</h4>
          <Area>
            <h4>1. {MUUTOS_WIZARD_TEKSTIT.MUUTOS_PERUSTELULOMAKKEET.YLEINEN.TARPEELLISUUS.FI}</h4>
            <textarea
              rows="5"
            />
            <h4>2. {MUUTOS_WIZARD_TEKSTIT.MUUTOS_PERUSTELULOMAKKEET.VAATIVA.JARJESTAMISEDELLYTYKSET}</h4>
            ...
            <textarea
              rows="5"
            />
            <h4>3. {MUUTOS_WIZARD_TEKSTIT.MUUTOS_PERUSTELULOMAKKEET.VAATIVA.SUUNNITELMA}</h4>
            <textarea
              rows="5"
            />
